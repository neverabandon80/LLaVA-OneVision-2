# =============================================================================
# LLaVA-OneVision2 30B-A3B – Stage-1 Alignment Training
# =============================================================================
# Main recommended setup in this script:
#   TP=1, PP=1, EP=8
#
# Usage:
#   bash alignment.sh [TP] [PP] [EP] [SEQ_LEN] [MBS] [GBS] [NSTEP]
# =============================================================================
...
CHECKPOINT_PATH=${CHECKPOINT_PATH:-"/workspace/LLaVA-OneVision-2/stage_0_llava_ov2_30b_a3b_release"}
...
TRAINING_ARGS=(
    ...
    # --custom-pipeline-recompute-layers 8,8 # ViT 24layers
