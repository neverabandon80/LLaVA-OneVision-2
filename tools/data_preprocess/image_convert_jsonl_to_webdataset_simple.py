...
def _build_sample(entry: dict, idx: int, image_root: str | None, sample_prefix: str) -> dict | None:
    """Build one sample for image-only JSONL entries (no fps handling)."""
    ...
    # Do not extract patch_positions into the webdataset; keep them as None by default.
